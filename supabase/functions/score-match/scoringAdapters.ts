// ⚠️ Deno copy of src/data/scoringAdapters.ts — byte-identical except this import
// line. src/lib/scoring.parity.test.ts fails if they drift; edit the source and
// re-copy. (cp src/data/scoringAdapters.ts supabase/functions/score-match/)
import type { GoalFact, MatchResult, Outcome, Prediction } from './scoring.ts'
